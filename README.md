...
If you use kLarity in your work, please cite:

```bibtex
@article{willer2026klarity,
  title   = {From Global Averages to Local Reality: Machine Learning Driven Quantification
             of Bubble Dynamics in a Pilot Scale Stirred Bioreactor},
  author  = {Willer, Emilie Overgaard and Siska, Maximilian and Victoria, Juliet J.
             and von Lieres, Eric and Woodley, John M.},
  year    = {2026},
  doi     = {placeholder}
}
```
